...
\makeatletter
\def\ecv@namekey{\ecv@utf{Cognome e nome}}
\def\ecv@addresskey{\ecv@utf{Indirizzo}}
\def\ecv@telkey{\ecv@utf{Telefono}}

\def\ecv@skypekey{\ecv@utf{Username Skype}}
\def\ecv@githubkey{\ecv@utf{Account Github}}
...
\providecommand{\ecvpersonalinfocomplete}[1][0pt]{%
...
\ecv@githubkey       &\ecv@github \tabularnewline[#1]
\fi
}
\makeatother
...
\ecvskype{enrico\_bencivenga}
%\ecvfax{Facoltativo}
\ecvemail{\url{enrico.bencivenga@hotmail.it}}
\ecvnationality{Italiana}
\ecvdateofbirth{13/04/1983}
\ecvgender{Maschile}
\ecvgithub{alanshearer}
%\ecvpicture[width=3cm]{images/fototessera2.png}
...
\\
\\
\ecvpersonalinfocomplete[30pt]
\\
%\ecvitem{Contatto Skype}{enrico_bencivenga}
%\ecvitem{Account Github}{\textbf{https://github.com/alanshearer}

\ecvitem{\large\textbf{Impiego ricercato}}{
\begin{minipage}[t]{1\linewidth}

\large\textbf{Sviluppatore .NET (WCF, Asp.NET MVC)}\\
%\large\textbf{Sviluppatore mobile}
\end{minipage}
}

\ecvsection{Esperienza professionale}
\ecvitem{Date}{Aprile 2013 - Oggi}
\ecvitem{Funzione o posto occupato}{Sviluppatore .NET}
\ecvitem{Principali mansioni e responsabilit\`a}{
\begin{minipage}[t]{1\linewidth}
Sviluppo di:
\begin{itemize}
\vspace{-3mm}\item[]Servizi WCF REST;
\vspace{-3mm}\item[]Applicazioni Web Asp.NET MVC4 e MVC5;
\vspace{-3mm}\item[]Interfacce utente.
\end{itemize}
\end{minipage}
}
\ecvitem{Strumenti utilizzati}{
\begin{minipage}[t]{1\linewidth}
...
\ecvitem{Nome e indirizzo del datore di lavoro}{Ancitel S.p.A., Via Vicinale Santa Maria del Pianto 80143 Napoli}
...
\ecvitem{Date}{Maggio 2014}
\ecvitem{Nome e tipo d'istituto di istruzione o formazione}{
\begin{minipage}[t]{1\linewidth}
Microsoft Learning\\ Certificazione Microsoft .NET Fundamentals 98-372 
\end{minipage}
}
\ecvitem{Qualifica conseguita}{\begin{minipage}[t]{1\linewidth}
Microsoft Certified Professional (\textbf{MCP})\\ \
Microsoft Technology Associate (\textbf{MTA})
\end{minipage}}
\ecvitem{Principali materie}{
\begin{minipage}[t]{1\linewidth}
Basi di Microsoft .NET Framework;\\
Namespaces e classi; \\
Compilazione del codice .NET; \\
Classi di I/O; \\
...
\ecvitem{Date}{2002 - Gennaio 2014}
\ecvitem{Nome e tipo d'istituto di istruzione o formazione}{
\begin{minipage}[t]{1\linewidth}
Università degli Studi di Napoli "Federico II"\\ Corso di Laurea in Ingegneria Informatica 
\end{minipage}
}
\ecvitem{Certificato o diploma ottenuto}{Laurea triennale in Ingegneria Informatica}
\ecvitem{Principali materie}{
\begin{minipage}[t]{1\linewidth}
Ingegneria del Software(UML, Java);\\
Basi di Dati (SQL, Java); \\
Programmazione I (C, C++);\\
Programmazione II (Java); \\
Tecnologie dei Sistemi di Automazione.
\end{minipage}
}
\ecvitem{Tesi}{Tesi di Laurea su \emph{Un'applicazione mobile per la navigazione assistita di siti culturali}, ovvero studio e realizzazione di un'applicazione mobile per la visita assistita del sito culturale degli Scavi di Paestum su piattaforma Windows Phone 8.\\
\vspace{3mm}
}
...
\ecvitem{Certificato o diploma ottenuto}{Tecnico di ricerca sui servizi della P.A. Progetto SMART (Services and Meta-services for smART eGovernment)}
\ecvitem{Principali materie/Competenze professionali apprese}{
\begin{minipage}[t]{1\linewidth}
...
\ecvitem{Date}{1996 - 2001}
\ecvitem{Nome e tipo d'istituto di istruzione o formazione}{
\begin{minipage}[t]{1\linewidth}
Liceo Classico "V.Imbriani", 80038 Pomigliano D'Arco (Napoli),\\
Indirizzo Matematica ed Informatica.
\end{minipage}
}
\ecvitem{Certificato o diploma da ottenere}{Licenza liceale classica}
\ecvitem{Principali materie}{
\begin{minipage}[t]{1\linewidth}
Latino;\\
Greco; \\
...
Ottima conoscenza delle suite di produttività:
\begin{itemize}
\vspace{-3mm}\item[]Microsoft Office 2003, 2007, 2010, 2013;
\vspace{-3mm}\item[]OpenOffice, LibreOffice.
\end{itemize}
...
\ecvitem{Firma}{
\begin{minipage}[t]{1\linewidth}
\small \emph{Ai sensi del D. Lgs. 196 del 30/6/2003, autorizzo al trattamento dei miei dati personali per le vostre esigenze di selezione e comunicazione e dichiaro di essere informato dei diritti di cui l'articolo 13 a me spettanti}
\vspace{3mm}
\newline
